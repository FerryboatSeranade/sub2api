...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "extra_quota", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "extra_quota_used", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
	...
	APIKeysTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "apikey_extra_quota_extra_quota_used",
				Unique:  false,
