...
func init() {
	...
	// apikeyDescExtraQuota is the schema descriptor for extra_quota field.
	apikeyDescExtraQuota := apikeyFields[10].Descriptor()
	// apikey.DefaultExtraQuota holds the default value on creation for the extra_quota field.
	apikey.DefaultExtraQuota = apikeyDescExtraQuota.Default.(float64)
	// apikeyDescExtraQuotaUsed is the schema descriptor for extra_quota_used field.
	apikeyDescExtraQuotaUsed := apikeyFields[11].Descriptor()
	// apikey.DefaultExtraQuotaUsed holds the default value on creation for the extra_quota_used field.
	apikey.DefaultExtraQuotaUsed = apikeyDescExtraQuotaUsed.Default.(float64)
