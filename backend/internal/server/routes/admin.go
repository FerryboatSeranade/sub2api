...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.POST("/:id/api-keys", h.Admin.APIKey.CreateForUser)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/:id/test-models", h.Admin.Account.SerialTest)
		accounts.GET("/:id/test-models/preset", h.Admin.Account.SerialTestPreset)
		accounts.PUT("/:id/test-models/preset", h.Admin.Account.SerialTestPreset)
