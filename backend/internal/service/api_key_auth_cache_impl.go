...
const apiKeyAuthSnapshotVersion = 14 // v14: include api key extra quota and group video pricing fields
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	snapshot := &APIKeyAuthSnapshot{
		...
		ExtraQuota:     apiKey.ExtraQuota,
		ExtraQuotaUsed: apiKey.ExtraQuotaUsed,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	apiKey := &APIKey{
		...
		ExtraQuota:     snapshot.ExtraQuota,
		ExtraQuotaUsed: snapshot.ExtraQuotaUsed,
