...
type APIKeyAuthSnapshot struct {
	...
	ExtraQuota     float64 `json:"extra_quota"`      // Extra rate-limit overflow quota in USD
	ExtraQuotaUsed float64 `json:"extra_quota_used"` // Used extra rate-limit overflow quota amount
