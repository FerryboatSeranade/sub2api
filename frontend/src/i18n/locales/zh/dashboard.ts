export default {
  ...
  keys: {
    ...
    extraQuota: '额外限速额度',
    extraQuotaLimit: '额外限速额度',
    extraQuotaAmountPlaceholder: '输入 USD 额外额度',
    extraQuotaAmountHint: '普通 5小时/日/7天限额用完后才消耗。0 = 不启用；仍受密钥过期时间限制。',
    extraQuotaUsed: '已用额外限速额度',
    resetExtraQuotaUsed: '将已用额外限速额度重置为 0',
    resetExtraQuotaTitle: '确认重置额外限速额度',
    resetExtraQuotaConfirmMessage: '确定要将密钥 "{name}" 的已用额外限速额度（${used}）重置为 0 吗？此操作不可撤销。',
    extraQuotaResetSuccess: '额外限速额度重置成功',
    failedToResetExtraQuota: '重置额外限速额度失败',
