export default {
  ...
  keys: {
    ...
    extraQuotaLimit: 'Extra Rate Limit Quota',
    extraQuotaAmountPlaceholder: 'Enter extra quota in USD',
    extraQuotaAmountHint: 'Used only after the regular 5-hour, daily, or 7-day limit is exhausted. 0 = disabled; key expiration still applies.',
    extraQuotaUsed: 'Extra Rate Limit Quota Used',
    resetExtraQuotaUsed: 'Reset used extra rate limit quota to 0',
    resetExtraQuotaTitle: 'Confirm Reset Extra Quota',
    resetExtraQuotaConfirmMessage: 'Are you sure you want to reset the used extra rate limit quota (${used}) for key "{name}" to 0? This action cannot be undone.',
    extraQuotaResetSuccess: 'Extra rate limit quota reset successfully',
    failedToResetExtraQuota: 'Failed to reset extra rate limit quota',
