export default {
    ...
    users: {
      ...
      createApiKeyHint: 'Create an API key for this user',
      editApiKey: 'Edit API Key',
      editApiKeyHint: 'Edit this API key quota and limits',
      saveApiKeyHint: 'Save API key settings',
      changeApiKeyGroupHint: 'Change this API key group binding',
      apiKeyName: 'Key name',
      apiKeyNameRequired: 'Enter a key name',
      customApiKey: 'Custom key',
      customApiKeyPlaceholder: 'Leave empty to auto-generate',
      customApiKeyHint: 'Optional. Useful for migrations or pre-provisioned external systems.',
      apiKeyStatus: 'Status',
      apiKeyStatusActive: 'Active',
      apiKeyStatusDisabled: 'Disabled',
      apiKeyStatusQuotaExhausted: 'Quota exhausted',
      apiKeyStatusExpired: 'Expired',
      apiKeyQuota: 'Total quota',
      apiKeyQuotaUsed: 'Used total quota',
      extraQuota: 'Extra rate-limit quota',
      extraQuotaUsed: 'Used extra rate-limit quota',
      extraQuotaHint: 'Used only after regular 5h/daily/weekly limits are exhausted; still expires with the key.',
      apiKeyExpiresAt: 'Expiration',
      apiKeyExpiresAtHint: 'Leave empty for no expiration. Extra quota expires with the key.',
      rateLimitSection: 'Rate-limit windows',
      rateLimitHint: '0 means unlimited. Requests use regular window quota first, then extra rate-limit quota.',
      rateLimit5h: '5-hour limit',
      rateLimit1d: 'Daily limit',
      rateLimit7d: '7-day limit',
      resetQuotaUsed: 'Also reset used total quota',
      resetExtraQuotaUsed: 'Also reset used extra rate-limit quota',
      resetRateLimitUsage: 'Also reset 5h/daily/weekly usage',
      zeroUnlimitedHint: 'Use 0 for unlimited',
      unlimited: 'Unlimited',
      disabled: 'Disabled',
      neverExpires: 'Never expires',
      nonNegativeAmountRequired: 'Quota and limit values must be 0 or positive',
      invalidExpiration: 'Choose a valid expiration time',
      apiKeyCreated: 'API key created',
      apiKeySaved: 'API key saved',
      apiKeySavedWithGrant: 'API key saved. User auto-granted access to "{group}"',
